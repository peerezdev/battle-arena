...
export const HELP_FEATURES: HelpFeature[] = [
  ...
  { title: 'Gimmighouls', accent: '#f5c542', body: 'Points you earn just by playing: 0.5 per dollar in battles and 0.1 per dollar in gacha. They are not a currency and they do not affect your odds. They track how much you have played and feed the ranking.', iconPaths: '<circle cx="12" cy="12" r="8"/><path d="M12 8v8M9 12h6"/>' },
