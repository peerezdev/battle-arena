...
const TODOS = new Set(['pack', 'royale'] as const)
...
describe('LiveBattles', () => {
  it('renders a card and fires join', () => {
    ...
    render(<LiveBattles modos={TODOS} onModos={() => {}} battles={[b]} onBattleAction={onBattleAction} onOpen={vi.fn()} />)
  ...
  it('shows the seats-left note whenever seats are open (not only "Filling")', () => {
    ...
    render(<LiveBattles modos={TODOS} onModos={() => {}} battles={[pack]} onBattleAction={vi.fn()} onOpen={vi.fn()} />)
  ...
  it('hides the seats-left note when the lobby is full', () => {
    ...
    render(<LiveBattles modos={TODOS} onModos={() => {}} battles={[full]} onBattleAction={vi.fn()} onOpen={vi.fn()} />)
  ...
  it('mobile: compact card shows the pot box and the seats line instead of the header pot row', () => {
    mocks.wide = false
    render(<LiveBattles modos={TODOS} onModos={() => {}} battles={[b]} onBattleAction={vi.fn()} onOpen={vi.fn()} />)
  ...
  it('the segmented filters actually filter (All / Ready to join / Mine / Recent)', () => {
    ...
    render(<LiveBattles modos={TODOS} onModos={() => {}} battles={[lobby, running, done]} meWallet="ME" onBattleAction={vi.fn()} onOpen={vi.fn()} />)
  ...
  it('shows an empty-state message when a filter matches nothing', () => {
    ...
    render(<LiveBattles modos={TODOS} onModos={() => {}} battles={[lobby]} onBattleAction={vi.fn()} onOpen={vi.fn()} />)
